...
// Step 4 Use a conditional statement to check the result of the coin flip. If it’s 0, write out “Heads” into the console window. If it’s 1, write out 
// “Tails” into the console window.
// if (flipResult == "0") {
//        alert("Heads");
//    } else {
// if (coinFlip == 1) {
